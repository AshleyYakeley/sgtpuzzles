...
#else
    { 30, 16, DIFF_HARD,   LOOPY_GRID_SQUARE },
    { 20, 12, DIFF_HARD,   LOOPY_GRID_TRIANGULAR },
    { 16,  9, DIFF_HARD,   LOOPY_GRID_SNUBSQUARE },
    { 16,  9, DIFF_HARD,   LOOPY_GRID_CAIRO },
    { 12,  8, DIFF_HARD,   LOOPY_GRID_KITE },
    { 30, 18, DIFF_HARD,   LOOPY_GRID_PENROSE_P2 },
    { 30, 18, DIFF_HARD,   LOOPY_GRID_PENROSE_P3 },
    { 30, 15, DIFF_HARD,   LOOPY_GRID_HONEYCOMB },
    { 16,  8, DIFF_HARD,   LOOPY_GRID_GREATHEXAGONAL },
    { 20, 12, DIFF_HARD,   LOOPY_GRID_KAGOME },
    { 16,  8, DIFF_HARD,   LOOPY_GRID_OCTAGONAL },
    { 16,  8, DIFF_HARD,   LOOPY_GRID_FLORET },
    { 12,  8, DIFF_HARD,   LOOPY_GRID_DODECAGONAL },
    { 12,  8, DIFF_HARD,   LOOPY_GRID_GREATDODECAGONAL },
    { 10,  6, DIFF_HARD,   LOOPY_GRID_GREATGREATDODECAGONAL },
    { 12,  6, DIFF_HARD,   LOOPY_GRID_COMPASSDODECAGONAL },
#endif
};
...
static game_drawstate *game_new_drawstate(drawing *dr, const game_state *state)
{
    ...
    memset(ds->needed_lines_yes, 0, num_faces * sizeof(int));
    memset(ds->needed_lines_no, 0, num_faces * sizeof(int));
    for (i = 0; i < num_faces; i++)
...
#define REDRAW_OBJECTS_LIMIT 16		/* Somewhat arbitrary tradeoff */
    ...
    for (i = 0; i < g->num_faces; i++) {
        ...
        needed_lines_yes = n           - yes_order;
        needed_lines_no  = (sides - n) - no_order;
